...
<head>
    ...
    .header-image {
        background-image: url('images/bg/about (1).png'); /* Path to your cover image */
        background-size: cover; /* Ensures the image covers the entire div */
        background-position: center top; /* Center the image horizontally, align it to the top vertically */
        height: 650px; /* Set to half of the image height (1080px / 2) */
        width: 100%;
    }

    .body-image {
        background-image: url('images/bg/body.png'); /* Path to your cover image */
        background-size: cover; /* Ensures the image covers the entire div */
        background-position: center top; /* Center the image horizontally, align it to the top vertically */
        height: 1400px; /* Set to half of the image height (1080px / 2) */
        width: 100%;
    }
    ...
    .corner-image {
        position: absolute;
        bottom: -290px; /* Adjust the spacing from the bottom */
        left: 90px;   /* Adjust the spacing from the left */
        width: 57%; /* Adjust the size of the image as needed */
    ...
    .corner-image-one {
        position: relative;
        bottom: -375px; /* Adjust the spacing from the bottom */
        right: -347px;   /* Adjust the spacing from the left */
    ...
    .corner-image-two {
        position: relative;
        bottom: -250px; /* Adjust the spacing from the bottom */
        right: -450px;   /* Adjust the spacing from the left */
        width: 75%; /* Adjust the size of the image as needed */
    ...
    .corner-text-one {
        position: relative;
        bottom: -270px; /* Adjust the spacing from the bottom */
        right: -630px; /* Align with corner-image-one */
        color: white; /* Text color */
    ...
    .corner-text-two {
        position: absolute;
        bottom: -130px; /* Adjust the spacing from the bottom */
        left: -320px; /* Align with corner-image-two */
        color: white; /* Text color */
        font-size: 20px;
    }
    ...
    .corner-text-two p {
        position: absolute;
        left: 0px; /* Align with corner-image-two */
        color: white; /* Text color */
    ...
    justify-content: space-around;
    align-items: center;
    margin-top: -1500px; /* Adjust the spacing */
    padding: 20px;
    }
    ...
    .profile-pic {
        width: 200px; /* Set the width for the profile picture */
        height: 200px; /* Set the height for the profile picture */
        object-fit: cover; /* Ensures the image covers the space */
        border: 10px solid white; /* Add a border if desired */
...
<div class="profile-container d-flex justify-content-around py-3">
    ...
    <div class="corner-image-two">
        ...
        <h3>Capture moments, tell stories.</h3>
            <p>"Photography is the delicate dance of light and shadow, capturing the essence of fleeting moments and rendering them timeless. It is a silent, visual poetry that distills emotions into a frame, letting us glimpse the soul of the world."
            </p>
        </div>
            <!-- Image in the bottom right corner -->
